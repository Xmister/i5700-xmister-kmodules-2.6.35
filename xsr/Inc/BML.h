...
#define		BML_VERSION_MISMATCH			XSR_RETURN_VALUE(1, 0x001B, 0x0000)
#define     BML_CANT_GET_LOCK_STATUS        XSR_RETURN_VALUE(1, 0x001C, 0x0000)
...
#define     PARTITION_ID_EBOOT              6  /* Bootloader       */
#define     PARTITION_ID_EBOOTCFG           7  /* Bootloader Configuration   */

#define     PARTITION_ID_RESERVED           PARTITION_USER_DEF_BASE

#elif defined(LINUX_OAM)

#define     PARTITION_ID_NBL2               1  /* NAND bootloader 2          */
#define     PARTITION_ID_NBL3               2  /* NAND bootloader 3          */
#define     PARTITION_ID_PARAM              5
#define     PARTITION_ID_UPDATEUTIL         6
...
/*  nVol      = 0;                                                           */
/*                                                                           */
/*  BML_IOCtl(nVol, BML_IOCTL_GET_FULL_PI_EX, NULL, 0,                          */
/*            stPI, sizeof(XSRPartI), &nRet)                                 */
/*****************************************************************************/
#define     BML_IOCTL_GET_FULL_PI_EX         XSR_IOCTL_CODE(XSR_MODULE_BML,  \
                                                    9,                      \
                                                    XSR_METHOD_BUFFERED,    \
                                                    XSR_READ_ACCESS)
...
/*  nVol      = 0;                                                           */
/*                                                                           */
/*  BML_IOCtl(nVol, BML_IOCTL_GET_BLOCK_STAT, &nBufIn, sizeof(UINT32),       */
/*            &nBufOut, sizeof(UINT16), &nRet)                               */
/*****************************************************************************/
#define     BML_IOCTL_GET_BLOCK_STAT         XSR_IOCTL_CODE(XSR_MODULE_BML,  \
                                                    10,                      \
                                                    XSR_METHOD_BUFFERED,     \
                                                    XSR_READ_ACCESS)
