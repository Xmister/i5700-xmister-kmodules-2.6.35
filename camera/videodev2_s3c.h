...
//	#define VIDIOC_G_AF					_IOW  ('V',104, void *)
	#define VIDIOC_S_PREVIEW_SIZE		_IOW  ('V',105, void *)
//	#define VIDIOC_S_SET_PREVIEW		_IOW  ('V',106, void *)
//	#define VIDIOC_S_START_CAPTURE		_IOW  ('V',107, void *)
	#define VIDIOC_S_JPEG_TRANSFER		_IOW  ('V',108, void *)
	#define VIDIOC_S_CAPTURE_SIZE		_IOW  ('V',109, void *)
	#define VIDIOC_G_JPEG_SIZE			_IOW  ('V',110, void *)
	#define VIDIOC_S_JPEG_QUAL			_IOW  ('V',111, void *)
